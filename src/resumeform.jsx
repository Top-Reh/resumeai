  ...
  return (
    <div className="p-10 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-6 mb-10">
        ...
        <InputField id="companyName" label="Company name" placeholder="Company name" value={alldata.companyname} onChange={e=>setAlldata({...alldata,companyname:e.target.value})}/>
      ...
      <div className='bg-white py-3 flex align-middle justify-center rounded-[8px] '>
